        ...
        <div className='payment-details flex flex-col gap-4 p-4 rounded-lg shadow-md'>
          ...
          <div className=' w-full grid grid-cols-2 gap-4'>
            <div class="col-span-2 sm:col-span-1">
                <label for="full_name" class="mb-2 block text-sm font-medium text-gray-300"> Full name (as displayed on card)* </label>
            ...
            <div class="col-span-2 sm:col-span-1">
              <label for="card-number-input" class="mb-2 block text-sm font-medium text-gray-300"> Card number* </label>
            ...
            <div>
              <label for="card-expiration-input" class="mb-2 block text-sm font-medium text-gray-300">Card expiration* </label>
              <div class="relative">
            ...
            <div>
              <label for="cvv-input" class="mb-2 flex items-center gap-1 text-sm font-medium text-gray-300">
                CVV*
