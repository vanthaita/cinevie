        ...
        <main >
            <section className="relative">
                <div className="relative bg-black flex justify-start items-start" style={{height: 'calc(100vh - 80px)'}}>
                    ...
                    <div className=" h-[310px] z-30 mx-20 w-[75%] my-20 flex flex-col justify-start items-start gap-y-4">
            ...
            {/* 0 */}
            <section className="w-full h-full px-20 flex flex-col justify-center items-center mb-36" style={{ height: 'calc(100vh - 80px)' }}>
                <div className="h-full z-30 w-full flex flex-col justify-start items-start gap-y-4 mt-20">
                    <h1 className="font-bold text-2xl mb-4">Aeon Mall Cinema</h1>
                    <p className="font-normal text-xl text-gray-400">
                    ...
                    <div className="flex flex-col items-start gap-y-1">
                        <div className="flex flex-row justify-center items-center gap-x-2">
                            ...
                            <p className="font-normal text-xl text-gray-400"> Aeon Mall Binh Duong, 27 Dai lo Binh Duong, Hoa Long Ward, Thuan An, Binh Duong, Vietnam</p>
                        </div>
                        <div className="flex flex-row justify-center items-center gap-x-2">
                            <h2 className="font-medium text-xl">Phone: </h2>
                            <p className="font-normal text-xl text-gray-400"> 123 456 789 </p>
                        </div>
                        <div className="flex flex-row justify-center items-center gap-x-2">
                            <h2 className="font-medium text-xl">Hours: </h2>
                            <p className="font-normal text-xl text-gray-400">10 AM - 10 PM</p>
                        </div>
                    </div>

                    <div className="flex justify-start flex-col mt-6 w-full">
                        <div className="flex" style={{ overflowX: "auto", scrollbarWidth: "none" }}>
                            <div className="flex space-x-12">
                                <div className="w-[380px] rounded-xl h-[290px]">
            ...
            {/* 2 */}
            <section className="w-full h-full px-20 flex flex-col justify-center items-center mb-44" style={{ height: 'calc(100vh - 80px)' }}>
                <div className="h-full z-30 w-full flex flex-col justify-start items-start gap-y-4 mt-20">
                    <h1 className="font-bold text-2xl mb-4">Aeon Mall Cinema</h1>
                    <p className="font-normal text-xl text-gray-400">
                        Aeon Mall Cinema is part of the Aeon Mall, a large shopping center chain in many countries, especially in Asia. Its a popular entertainment destination for both families and friends. Aeon Mall Cinema offers a modern movie-watching experience with the latest films from various genres. With standard or VIP theaters, Aeon Mall Cinema is committed to providing customers with comfort and an excellent movie-watching experience.
