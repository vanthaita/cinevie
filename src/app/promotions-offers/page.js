                    ...
                    <div className="w-full h-full absolute md:px-20 px-8 md:mt-10  mt-6 rounded-xl flex md:flex-row flex-col-reverse md:justify-between justify-center items-center" style={{height: 'calc(65vh - 80px)'}}>
                        ...
                        <div className="md:w-[45%] w-full h-full flex flex-col justify-start items-start gap-y-[15px] md:gap-y-[25px]">
                            ...
                            <div className="flex flex-col gap-y-2">
                                <h1 className="font-bold text-xl md:text-2xl">C’STUDENT - 45K FOR STUDENTS</h1>
                                <p className="font-normal text-xs md:text-sm">SAME PRICE 45K/2D FOR STUDENTS/TEACHERS/U22 ALL WEEKEND AT ALL CINESTAR THEATER.</p>
                            </div>
                            <div className="flex flex-col gap-y-2">
                                ...
                                <p className="font-normal text-xs md:text-sm">Lecturer/teacher presents lecturer card.</p>
                            </div>
                            <div className="flex flex-col gap-y-2">
                                ...
                                <p className="font-normal text-xs md:text-sm">Does not apply to holidays, Tet, or screenings with surcharges from the film distributor.</p>
                            </div>
